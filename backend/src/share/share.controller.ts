...
export class ShareController {
  ...
  async handleEventShare(
    ...
    try {
      ...
      // Only use the first paragraph for social previews — everything after the first blank line (e.g. fee instructions) is excluded
      const description = rawDescription.split(/\r?\n\r?\n/)[0].replace(/\r?\n/g, ' ').trim();

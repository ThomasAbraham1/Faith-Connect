...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['https://www.faithconnect.store', 'https://faithconnect-474707.el.r.appspot.com', 'http://localhost:5173', 'http://43.204.208.225', 'http://app.harpazotech.com', 'https://app.harpazotech.com'],
    credentials: true,
  });
  ...
  app.use(
    session({
      ...
      cookie: {
        ...
        secure: isProduction ? true : false, // only send over https
        httpOnly: true,
        sameSite: 'lax',
      },
    }),
